...
class manipulator_mp:
    def __init__(self):
        rospy.init_node("manipulator_complete_mp", anonymous=False)
        ...
        self.default_joint_states[1] = -0.9199
        self.default_joint_states[2] = -1.2669
        self.default_joint_states[3] = 0
        self.default_joint_states[4] = -0.9546
