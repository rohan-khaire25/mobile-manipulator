...
from mobile_manipulator_robot.msg import Tracker
...
tracker = Tracker()
class manipulator_vision:
    def __init__(self):
        rospy.init_node("manipulator_vision", anonymous=False)
        self.track_flag = False
        self.default_pose_flag = True
        self.cx = 400.0
        self.cy = 400.0
        self.bridge = cv_bridge.CvBridge()
        self.image_sub = rospy.Subscriber('/manipulator_complete/usbcam/image_raw', Image, self.image_callback)
